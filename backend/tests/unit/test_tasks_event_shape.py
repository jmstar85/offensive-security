...
def test_executor_lifecycle_events_carry_step_dict():
    # PlanExecutor.execute: 1 started, 1 completed, 2 failed (shim + generic).
    _assert_step_shape(
        EXECUTOR,
        {"agent_started": 1, "agent_completed": 1, "agent_failed": 2},
    )


def test_performer_lifecycle_events_carry_step_dict():
    # _execute_step_through_helper: 1 started, 1 completed, 2 failed.
    _assert_step_shape(
        PERFORMER,
        {"agent_started": 1, "agent_completed": 1, "agent_failed": 2},
    )
