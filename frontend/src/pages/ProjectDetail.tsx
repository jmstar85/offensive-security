...
import { getProject, listSessions } from '../api/client'
...
export default function ProjectDetail() {
  ...
  const startWorkflow = () => {
    if (!id) return
    navigate(`/pentest-sessions/new?project=${id}`)
  }
  ...
  return (
    <div className="min-h-screen bg-gray-950 p-8">
      ...
      <div className="bg-gray-900 rounded-xl p-6 border border-gray-800 mb-6 flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold mb-1">Launch New Pentest Session</h2>
          <p className="text-gray-400 text-sm">
            Start a chat-driven workflow. The AI drafts a plan, asks clarifying questions, and
            only executes after you approve.
          </p>
        </div>
        <button
          type="button"
